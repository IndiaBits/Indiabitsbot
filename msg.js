...
➡️ <a href="https://medium.com/@nellsonx/how-to-properly-invest-in-bitcoin-blockchain-and-other-cryptocurrencies-in-2017-32d59e2ff435">How to invest in Bitcoin,Blockchain and other cryptocurrencies properly</a>

➡️ <a href="https://www.amazon.in/Cryptoassets-Innovative-Investors-Bitcoin-Beyond/dp/1260026671/">Cryptoassets: The Innovative Investor's Guide to Bitcoin and Beyond Hardcover</a>

➡️ <a href="http://investorfieldguide.com/hashpower/">Hash Power : A Documentary on Blockchains & Cryptocurrencies</a>
`;

    this.dyor = () => `
<code>📌 Please understand posts here aren't investment advice.

🎯Everyone here is learning just as much as the next individual. Hence, rather than ask "what should i do about xyz?" It is helpful to perhaps share your thesis on a particular coin, explain your thoughts on why you would take a certain position (backed up with data, if possible) and then ask others for their opinions.

💡we do our best to share knowledge with the people but can't win every time.

⚠️ Don't follow other people's trades blindly. You don't know their position size, time frame, stop loss, or exit strategy.

🔎 Always DO YOUR OWN RESEARCH before investing.</code>
`;
    this.shill = () => `
<code>Shilling Is Allowed 'When' Its Backed By Data.

✅Shill Facts, Shill Data, Shill Concepts.
...
📌 Here is a list of some p2p Platforms-Bisq, LocalBitcoins, localEthereum,Giottus, HodlHodl, Instashift, Paxful, Koinex, Wazirx
